    ...
    public partial class C07_Promotion : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (i == 0)
            {
                ...
                {
                    String a = list.Rows[(list.Rows.Count - 1)].Cells[0].Value.ToString();
                    if (bus.addPromotion(a, int.Parse(txtID.Text), float.Parse(txtPrice.Text), image, dateTimeStart.Value, dateTimeEnd.Value, txtContent.Text))
                    {
